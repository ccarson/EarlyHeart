/*
-- =============================================
-- Author:		Mike Schlecht
-- Create date: 11/01/2011
-- Description: Insert one Issue or Update one Issue 
--		        
--
-- =============================================

CREATE Proc [dbo].[IssueAddUpdateII]
	  (    @inIssueID   int = null,
           @inClientID  int,          
          ...
          BEGIN
            ...
            UPDATE Issues
               SET                      
                  ...
                  BondRatingSPind =        @inBondRatingSP,
                  BondRatingMoodysind =    @inBondRatingMoodys,
                  BondRatingFitchind =     @inBondRatingFitch,
