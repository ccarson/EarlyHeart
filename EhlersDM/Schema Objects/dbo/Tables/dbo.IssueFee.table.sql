CREATE TABLE dbo.IssueFee (
  ...
  , CONSTRAINT UX_IssueFee UNIQUE NONCLUSTERED ( IssueID ASC, FeeTypeID ASC, Ordinal ASC )
  ...
  , CONSTRAINT FK_IssueFee_IssueFirm        FOREIGN KEY ( IssueFirmsID )        REFERENCES dbo.IssueFirms ( IssueFirmsID )
        ON DELETE CASCADE
) ;
GO
