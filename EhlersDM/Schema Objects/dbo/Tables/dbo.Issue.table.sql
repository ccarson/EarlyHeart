CREATE TABLE dbo.Issue (
  ...
  , DisseminationFirmCategoriesID   INT             NULL
  ...
  , CONSTRAINT FK_Issue_DisseminationFirmCategories
        FOREIGN KEY ( DisseminationFirmCategoriesID ) REFERENCES dbo.FirmCategories ( FirmCategoriesID )
