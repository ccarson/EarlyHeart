CREATE TABLE [dbo].[StatutoryAuthorityJurisdictionTypes] (
    ...
    [ModifiedDate]                          DATETIME     CONSTRAINT [DF_StatutoryAuthorityJurisdictionTypes_ModifiedDate] DEFAULT (getdate()) NOT NULL,
    ...
    CONSTRAINT [FK_StatutoryAuthorityJurisdictionTypes_JurisdictionType] FOREIGN KEY ([JurisdictionTypeID]) REFERENCES [dbo].[JurisdictionType] ([JurisdictionTypeID]),
