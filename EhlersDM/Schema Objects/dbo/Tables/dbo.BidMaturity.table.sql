CREATE TABLE dbo.BidMaturity (
  ...
  , OriginalPaymentAmount DECIMAL (15, 2) NOT NULL   CONSTRAINT DF_BidMaturity_OrginalMaturity DEFAULT ((0))
...
CREATE INDEX IX_BidMaturity_Compare ON dbo.BidMaturity ( 
    BidderID ASC, PaymentDate ASC, PaymentAmount ASC
        , OriginalPaymentAmount ASC, InterestRate ASC, TermBond ASC ) ;
