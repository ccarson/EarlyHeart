CREATE TABLE dbo.Bidder (
    BidderID        INT             NOT NULL    CONSTRAINT PK_Bidder PRIMARY KEY CLUSTERED    IDENTITY
  ...
  , CONSTRAINT FK_Bidder_BidSource  FOREIGN KEY ( BidSourceID ) REFERENCES dbo.BidSource ( BidSourceID )
  , CONSTRAINT FK_Bidder_Firm       FOREIGN KEY ( FirmID )      REFERENCES dbo.Firm      ( FirmID )
  , CONSTRAINT FK_Bidder_Issue      FOREIGN KEY ( IssueID )     REFERENCES dbo.Issue     ( IssueID )
) ;
GO
