CREATE TABLE dbo.IssuePostBond (
    IssuePostBondID         INT             NOT NULL    CONSTRAINT PK_IssuePostBond PRIMARY KEY CLUSTERED   IDENTITY
  , IssueID                 INT             NOT NULL    CONSTRAINT UX_IssuePostBond_IssueID UNIQUE NONCLUSTERED
  ...
  , WeightedAverageMaturity DECIMAL (12,3)  NOT NULL    CONSTRAINT DF_IssuePostBond_WeightedAverageMaturity DEFAULT 0
