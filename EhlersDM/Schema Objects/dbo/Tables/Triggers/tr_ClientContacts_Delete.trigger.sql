...
************************************************************************************************************************************
    ...
    Trigger:    tr_ClientContacts_Delete
     Author:    Chris Carson
    Purpose:    Drops legacy ClientContacts records after deletion in Client application
    ...
    Logic Summary:
    1)  DELETE edata.ClientContacts based on trigger data
...
BEGIN TRY
    ...
    DECLARE @codeBlockNum       AS INT
          ...
          , @codeBlockDesc01    AS SYSNAME  = 'DELETE edata.ClientContacts based on trigger data'
...
/**/SELECT  @codeBlockNum = 01, @codeBlockDesc = @codeBlockDesc01 ; --  DELETE edata.ClientContacts based on trigger data
    DELETE  edata.ClientContacts
